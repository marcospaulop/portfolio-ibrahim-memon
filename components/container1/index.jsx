...
import Man from '../../public/Me.png'

export function Presentation() {
  return (
    <div id="home" className={styles.container}>
      <div className={styles.image}>
        <img src={Man} alt="Man illustation with an Macbook in his front" />
      </div>
      <div className={styles.text}>
        <h4 className={styles.text1}>
          ...
          Hello! I Am <strong>Ibrahim Memon</strong>
        </h4>
        <h4 className={styles.text2}>A Designer who</h4>
